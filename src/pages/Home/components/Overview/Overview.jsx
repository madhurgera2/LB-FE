    ...
    <div className="overview-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          <h1>Saving Lives, One Donation at a Time At LifeBridge</h1>
          <p>
            Your blood and Oragn Donation can make a difference. Join us in helping those in need.
          </p>
      ...
      <section className="how-it-works">
        ...
        <div className="steps">
          ...
          <div className="step">
            ...
            <p>Donate blood and Organs in a safe and comfortable environment.</p>
          </div>
          <div className="step">
          ...
          <div className="step">
            <div className="step-icon">4</div>
            <h3>Recovery & Refresh</h3>
            <p>Organ Donation helps in living another life.</p>
          </div>
        </div>
      </section>
    </div>
